...
//          $param =  [$kd_perusahaan, $week];
        ...
        //$status_dashboard = array("total_perimeter" => 0, "sudah_dimonitor" => 0, "belum_dimonitor" => 0,);
        return response()->json(['status' => 200,'page_end' =>$datacache['page_end'],
            'status_current_week' =>$datacache['status_current_week'],'data_dashboard' => $status_dashboard, 'data' => $datacache['data']]);
    }
