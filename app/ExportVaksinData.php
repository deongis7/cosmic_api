...
class ExportVaksinData extends DefaultValueBinder implements  FromCollection, WithCustomStartCell,WithHeadings,WithCustomValueBinder,WithColumnWidths,WithStyles
{
    /**
    * @param array $row
    *
    ...
    public function headings(): array
   {
     ...
     "Kota","NIK","Usia","No Handphone","Jumlah Keluarga Inti"]];
   }
